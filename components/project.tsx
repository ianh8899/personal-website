        ...
        >
            <section className="flex flex-col justify-center py-10">
                <div className="mx-auto px-4" style={{maxWidth: "90rem"}}>
                    <div
                        className="p-12 bg-white shadow-2xl rounded-lg dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 transition">
                        <div className="grid grid-cols-1 lg:grid-cols-7 gap-8 my-20 items-center">
                            ...
                            {/* Content */}
                            <div
                                className={`col-span-full ${isOdd ? "lg:col-span-4 lg:col-start-4" : "lg:col-span-4"}`}>
                                ...
                                <div
                                    className="hidden xl:block flex justify-center space-x-24 max-w-4xl mx-auto flex-wrap mt-8">
                                    {icons}
                                </div>
                            </div>
                                            ...
                                            {showCredentials && (
                                                <div className="absolute top-full left-1/2 transform -translate-x-1/2 translate-y-4 bg-black text-white p-4 rounded shadow-md mt-4 w-72">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <FaRegCopy
                                                            onClick={() => copyToClipboard(exampleUsername, 'username')}
                                                            className={`cursor-pointer ml-2 ${copied === 'username' ? 'bg-white rounded-full' : ''}`}
                                                        />
                                                    </div>
                                                    <div className="flex items-center mt-2 justify-between">
                                                        <p>Password: {examplePassword}</p>
                                                        <FaRegCopy
                                                            onClick={() => copyToClipboard(examplePassword, 'password')}
                                                            className={`cursor-pointer ml-2 ${copied === 'password' ? 'bg-white rounded-full' : ''}`}
                                                        />
                                                    </div>
                                                </div>
                                            )}
